...
#masses = [  '125', '160', '170', '180', '190', '210', '230', '250', '270', '300', '350', '400', '450', '500', '550', 
...
for mode, pi in prepid_M200_20UL16.items():
    ...
    for mass in masses:
        req['dataset_name'] = dataset_name.replace('M-200', 'M-' + mass)
        ...
        req['fragment'] = fragment.replace('M200', 'M' + mass)
        print req['fragment']
