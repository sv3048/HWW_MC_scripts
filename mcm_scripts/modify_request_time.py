#========
# this script will update a given request's time/event 
# e.g. python modify_request_time.py --prepid HIG-RunIIFall17wmLHEGS-00545 --time_event 20
#========          
...
parser.add_argument("--time_event",type=float, help="coumpute from local run",dest="time_event")
...
for prepid in prepids:
    ...
    if 'prepid' not in request:
        ...
        request[field_to_update] = [args.time_event]
