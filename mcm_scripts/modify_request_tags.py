'''
last used
python modify_request_tags.py --prepid HIG-RunIISummer20UL16wmLHEGEN-01587 --tags abcd3
# this script will update a given request's tags
# e.g. python modify_request_time.py --prepid HIG-RunIIFall17wmLHEGS-00545 --tags abcd
'''
...
for prepid in prepids:
    ...
    if 'prepid' not in request:
        ...
        # Modify what we want
        # tags is a list for each sequence step
        # request[field_to_update] = [args.tags]
        request[field_to_update].extend([args.tags])
